...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#0D0D12', padding: 14, paddingTop: 10 },
  header: { flexDirection: 'row', alignItems: 'center', marginBottom: 10, marginTop: 10 },
  spacerAbove: { height: 8 },
